...
do
	local _obj_0 = ENT
	GetRed, GetGreen, GetBlue = _obj_0.GetRed, _obj_0.GetGreen, _obj_0.GetBlue
end
local ENTITY = FindMetaTable("Entity")
local GetPos = ENTITY.GetPos
local radius = 0
local getCalculatedRadius, getCalculatedBrightness = nil, nil
do
	local GetEnabled, GetRadius, GetBrightness
	do
		local _obj_0 = ENT
		GetEnabled, GetRadius, GetBrightness = _obj_0.GetEnabled, _obj_0.GetRadius, _obj_0.GetBrightness
	end
...
do
	local GetStyle, GetNoModel, GetNoWorld, IsDeathTime, GetDecay
	do
		local _obj_0 = ENT
		GetStyle, GetNoModel, GetNoWorld, IsDeathTime, GetDecay = _obj_0.GetStyle, _obj_0.GetNoModel, _obj_0.GetNoWorld, _obj_0.IsDeathTime, _obj_0.GetDecay
	end
	...
	ENT.Think = function(self)
		...
		return SetRenderBounds(self, Vector(-radius, -radius, -radius), Vector(radius, radius, radius))
	end
end
do
	local materialCache, color = { }, Color(0, 0, 0)
	local GetSpriteAlpha, GetSpriteScale
	do
		local _obj_0 = ENT
		GetSpriteAlpha, GetSpriteScale = _obj_0.GetSpriteAlpha, _obj_0.GetSpriteScale
	end
